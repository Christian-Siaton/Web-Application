...
def bs_dashboard():
    ...
    try:
        ...
        formatted_data = [
            ...
            {"metric": "Total Debt", "year_one": info[0]["Total Debt"], "year_two": info[1]['Total Debt'], "year_three": info[2]['Total Debt'], "year_four": info[3]['Total Debt'], "year_five": info[4]['Total Debt']},
